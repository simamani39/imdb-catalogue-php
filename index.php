...
<head>
    ...
    <script language="javascript" type="text/javascript" src="https://codemirror.net/5/addon/display/placeholder.js"></script>
...
<body>
    <form target="frame" action="movietown.php" method="post">
        ...
        <textarea name="rawurl" id="code" placeholder="paste links separated with a new line" rows="8" cols="60"></textarea>
